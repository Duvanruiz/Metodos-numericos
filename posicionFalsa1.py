...
def false_position_method(equation, a, b, epsilon, max_iter):
    ...
    if f(a) * f(b) > 0:
        print("La función no cambia de signo en el intervalo dado. El método de la falsa posición no puede garantizar la convergencia.")
        sys.exit()
...
# Llamar a la función del método de la falsa posición
root, iter_count = false_position_method(equation, a, b, epsilon, max_iter)
